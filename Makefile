...
coverage:
	go test -v -coverprofile=coverage.out -covermode=atomic -coverpkg=./internal/... -timeout=120s -parallel=10 ./internal/resources/...
...
coverageacc:
	TF_ACC=1 go test -v -coverprofile=coverage-acc.out -covermode=atomic -coverpkg=./internal/... -count=1 -p 1 -timeout 120m ./internal/tests/...
